...
export default function RegisterPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-sm items-center p-6">
      <form className="w-full space-y-4 rounded-lg border bg-white p-6 shadow-sm" onSubmit={submit}>
        <h1 className="text-xl font-semibold">Create your Verosys organization</h1>
